                ...
                <div class="row g-3">
                    <?php if (!empty($featured)): ?>
                        <?php foreach (array_slice($featured, 0, 3) as $idx => $p): 
                            $img = $p['image'] ? asset_url($p['image']) : 'https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&w=600&q=80'; 
                            ...
                            <div class="lookbook-card shadow-sm d-flex flex-column" style="border-bottom: 4px solid #001F3F;">
                                ...
                                <div class="p-3 d-flex flex-column flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mt-auto pt-2 border-top border-light">
                                        <a href="<?= e(BASE_URL) ?>vendor-profile.php?id=<?= (int) $p['business_id'] ?>" class="text-decoration-none text-uppercase fw-bold lookbook-link" style="font-size: 0.72rem; letter-spacing: 0.5px; color: #001F3F !important;">
                                            Meet Artisan <i class="fa-solid fa-arrow-up-right-from-square ms-1 link-icon" style="font-size: 0.65rem;"></i>
                                        </a>
                                        <span class="text-warning" style="font-size: 0.75rem;"><i class="fa-solid fa-star"></i> 5.0</span>
                                    </div>
                                </div>
