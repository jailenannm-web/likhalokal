...
<div class="container py-5">
    ...
    <div class="row align-items-center mb-5 pb-5">
        <div class="col-lg-6 pe-lg-5">
            <span class="badge bg-primary text-white mb-3 bungee-font px-4 py-2" style="border-radius: 12px; background-color: var(--vinzons-blue) !important;">ESTABLISHED 1611</span>
            <h2 class="section-h2 text-blue mb-4">The Golden Legacy of <span class="text-amber">Indan</span></h2>
