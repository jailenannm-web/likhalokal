...
CREATE TABLE businesses (
  ...
  faq_price TEXT NULL,
  faq_availability TEXT NULL,
  faq_location TEXT NULL,
  faq_payment TEXT NULL,
  faq_delivery TEXT NULL,
  faq_hours TEXT NULL,
  faq_custom TEXT NULL,
...
CREATE TABLE messages (
  ...
  conversation_type ENUM('business_inquiry','admin_support') NOT NULL DEFAULT 'business_inquiry',
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
